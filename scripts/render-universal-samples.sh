...
# =========================================================================
# 1. SAMPLE 1: UNIVERSAL AMBIENT DINER
# =========================================================================
echo "=== [1/3] Rendering Universal Ambient Diner ==="
IMAGE1="$ROOT/images/universal_diner.jpg"
RAIN_OVERLAY="$ROOT/assets/overlays/cinematic_rain_loop.mp4"
AUDIO1="/tmp/audio_diner_universal.wav"
VIDEO1="$ROOT/output/universal-diner-sample.mp4"
TMP_CLIP1="/tmp/clip_diner_universal.mp4"
...
# =========================================================================
# 2. SAMPLE 2: UNIVERSAL AMBIENT CONSERVATORY
# =========================================================================
echo "=== [2/3] Rendering Universal Ambient Conservatory ==="
IMAGE2="$ROOT/images/universal_conservatory.jpg"
DUST_OVERLAY="$ROOT/assets/overlays/dust_motes_loop.mp4"
FOG_OVERLAY="$ROOT/assets/youtube-overlays/fog-overlay.mp4"
AUDIO2="/tmp/audio_conservatory_universal.wav"
VIDEO2="$ROOT/output/universal-conservatory-sample.mp4"
TMP_CLIP2="/tmp/clip_conservatory_universal.mp4"
...
echo ">> Rendering video with floating golden dust motes & twilight mist..."
ffmpeg -y -nostdin \
...
# =========================================================================
# 3. SAMPLE 3: UNIVERSAL AMBIENT ASTEROID KITCHEN
# =========================================================================
echo "=== [3/3] Rendering Universal Ambient Asteroid Kitchen ==="
IMAGE3="$ROOT/images/universal_asteroid_kitchen.jpg"
FOG_OVERLAY="$ROOT/assets/youtube-overlays/fog-overlay.mp4"
AUDIO3="/tmp/audio_asteroid_universal.wav"
VIDEO3="$ROOT/output/universal-asteroid-kitchen-sample.mp4"
TMP_CLIP3="/tmp/clip_asteroid_universal.mp4"
...
echo "=== ALL 3 UNIVERSAL AMBIENT SAMPLES RENDERED SUCCESSFULLY ==="
